...
urlpatterns = [
    ...
    path('update_animal/<int:pk>/',
         AnimalUpdateView.as_view(), name="update_animal"),
    path('adopt/<int:pk>/', AdoptView.as_view(), name="adopt_animal"),
    path('update_person/<int:pk>/',
         PersonUpdateView.as_view(), name="update_person"),
    ...
    path('delete_animal/<int:pk>/',
         AnimalDeleteView.as_view(), name="delete_animal"),
    path('delete_person/<int:pk>/',
         PersonDeleteView.as_view(), name="delete_person"),
